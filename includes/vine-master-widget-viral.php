...
class vine_master_widget_viral extends WP_Widget {
	...
	if ( $vine_title ){
		if (empty ($vine_title_new)){
			$vine_title_new = constant('VINE_MASTER_NAME');
...
<div style="background: url(<?php echo plugins_url('images/techgasp-hr.png', dirname(__FILE__)); ?>) repeat-x; height: 10px"></div>
		...
		<p><a class="button-secondary" href="https://wordpress.techgasp.com/vine-master/" target="_blank" title="<?php echo $plugin_master_name; ?> Info Page">Info Page</a> <a class="button-secondary" href="https://wordpress.techgasp.com/vine-master-documentation/" target="_blank" title="<?php echo $plugin_master_name; ?> Documentation">Documentation</a> <a class="button-primary" href="https://wordpress.techgasp.com/vine-master/" target="_blank" title="Visit Website">Get Add-ons</a></p>
	<?php
	}
 }
?>
